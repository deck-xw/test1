...
#define CONFIG_SDCARD_HOST 1
#define CONFIG_SD_HOST_INTF 1
...
#define CONFIG_MASTER_CORE 1
#define CONFIG_SLAVE_CORE_OFFSET 1769472
#define CONFIG_SLAVE_CORE_RESET_VALUE 1
