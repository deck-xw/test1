...
typedef enum
{
    UVC_ATTRIBUTE_RC_UNDEFINED = 0,
    UVC_ATTRIBUTE_SET_CUR = 1,
    UVC_ATTRIBUTE_GET_CUR = 2,
    UVC_ATTRIBUTE_GET_MIN,
    UVC_ATTRIBUTE_GET_MAX,
    UVC_ATTRIBUTE_GET_RES,
    UVC_ATTRIBUTE_GET_LEN,
    UVC_ATTRIBUTE_GET_INFO,
    UVC_ATTRIBUTE_GET_DEF,
} E_UVC_ATTRIBUTE_OP;
