...
static const lcd_rgb_t lcd_rgb =
{
	...
	.hsync_back_porch = 50,  //case 60Mhz:  type = 0.5us
	.hsync_front_porch = 100,  // case 60Mhz:  type = 0.5us
	.vsync_pulse_width = 4,
	.vsync_back_porch = 16,   // >=5
	.vsync_front_porch = 20,   // >=2
#else
	// .clk = LCD_20M,
	// .data_out_clk_edge = NEGEDGE_OUTPUT,
	...
	.hsync_pulse_width = 10/2,
	.hsync_back_porch = 50/2,  //case 60Mhz:  type = 0.5us
	.hsync_front_porch = 100/2,  // case 60Mhz:  type = 0.5us
	.vsync_pulse_width = 4/2,
	.vsync_back_porch = 16/2,   // >=5
	.vsync_front_porch = 20/2,   // >=2
#endif
};
...
static void lcd_nt35510_config(void)
{
	...
	delay_us(800);
#ifdef ili9806e
	lcd_spi_write_cmd(0x28);
	delay_ms(100);
	lcd_spi_write_cmd(0x10);
	delay_ms(100);

	lcd_spi_write_cmd(0xFF);        // Change to Page 1 CMD 
	...
	lcd_spi_write_cmd(0x08); //Output    SDA 
	lcd_spi_write_data(0x10); 

	lcd_spi_write_cmd(0x20);//set DE/VSYNC mode    
	lcd_spi_write_data(0x00); 	

	lcd_spi_write_cmd(0x21); //DE = 1 Active 
	lcd_spi_write_data(0x01); 
	
	lcd_spi_write_cmd(0x30);//Resolution setting 480 X 854
#ifdef PIN_480_800
	...
	lcd_spi_write_cmd(0x31); //Inversion setting 2-dot 
	lcd_spi_write_data(0x00); 
	
	lcd_spi_write_cmd(0x40); //BT  AVDD,AVDD
	lcd_spi_write_data(0x16); //
	
	lcd_spi_write_cmd(0x41);   
	lcd_spi_write_data(0x33);//22  
	
	lcd_spi_write_cmd(0x42);        
	lcd_spi_write_data(0x03); //VGL=DDVDH+VCIP -DDVDL,VGH=2DDVDL-VCIP 
	
	lcd_spi_write_cmd(0x43);       
	lcd_spi_write_data(0x09); //SET VGH clamp level 
	
	lcd_spi_write_cmd(0x44);       
	lcd_spi_write_data(0x06); //SET VGL clamp level 
	
	lcd_spi_write_cmd(0x50); //VREG1 
	lcd_spi_write_data(0x88); 
	
	lcd_spi_write_cmd(0x51); //VREG2 
	lcd_spi_write_data(0x88); 
	
	lcd_spi_write_cmd(0x52); //Flicker MSB 
	lcd_spi_write_data(0x00); 
	
	lcd_spi_write_cmd(0x53); //Flicker LSB 
	lcd_spi_write_data(0x49); //VCOM

	lcd_spi_write_cmd(0x55); // //Flicker  			
	lcd_spi_write_data(0x49); 
	...
	lcd_spi_write_data(0x00); 
	//++++++++++++++++++ Gamma Setting ++++++++++++++++++//
	lcd_spi_write_cmd(0xA0);  //Positive Gamma 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0xA1);        // 
	lcd_spi_write_data(0x09); 
	lcd_spi_write_cmd(0xA2);        // 
	lcd_spi_write_data(0x11); 
	lcd_spi_write_cmd(0xA3);        // 
	lcd_spi_write_data(0x0B); 
	lcd_spi_write_cmd(0xA4);        // 
	lcd_spi_write_data(0x05); 
	lcd_spi_write_cmd(0xA5);        // 
	lcd_spi_write_data(0x08); 
	lcd_spi_write_cmd(0xA6);        // 
	lcd_spi_write_data(0x06); 
	lcd_spi_write_cmd(0xA7);        // 
	lcd_spi_write_data(0x04); 
	lcd_spi_write_cmd(0xA8);        // 
	lcd_spi_write_data(0x09); 
	lcd_spi_write_cmd(0xA9);        // 
	lcd_spi_write_data(0x0C); 
	lcd_spi_write_cmd(0xAA);        // 
	lcd_spi_write_data(0x15); 
	lcd_spi_write_cmd(0xAB);        // 
	lcd_spi_write_data(0x08); 
	lcd_spi_write_cmd(0xAC);        // 
	lcd_spi_write_data(0x0F); 
	lcd_spi_write_cmd(0xAD);        // 
	lcd_spi_write_data(0x12); 
	lcd_spi_write_cmd(0xAE);        // 
	lcd_spi_write_data(0x09); 
	lcd_spi_write_cmd(0xAF);        // 
	lcd_spi_write_data(0x00); 
	///==============Nagitive
	lcd_spi_write_cmd(0xC0);        //Negative Gamma 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0xC1);        // 
	lcd_spi_write_data(0x09); 
	lcd_spi_write_cmd(0xC2);        // 
	lcd_spi_write_data(0x10); 
	lcd_spi_write_cmd(0xC3);        // 
	lcd_spi_write_data(0x0C); 
	lcd_spi_write_cmd(0xC4);        // 
	lcd_spi_write_data(0x05); 
	lcd_spi_write_cmd(0xC5);        // 
	lcd_spi_write_data(0x08); 
	lcd_spi_write_cmd(0xC6);        // 
	lcd_spi_write_data(0x06); 
	lcd_spi_write_cmd(0xC7);        // 
	lcd_spi_write_data(0x04); 
	lcd_spi_write_cmd(0xC8);        // 
	lcd_spi_write_data(0x08); 
	lcd_spi_write_cmd(0xC9);        // 
	lcd_spi_write_data(0x0C); 
	lcd_spi_write_cmd(0xCA);        // 
	lcd_spi_write_data(0x14); 
	lcd_spi_write_cmd(0xCB);        // 
	lcd_spi_write_data(0x08); 
	lcd_spi_write_cmd(0xCC);        // 
	lcd_spi_write_data(0x0F); 
	lcd_spi_write_cmd(0xCD);        // 
	lcd_spi_write_data(0x11); 
	lcd_spi_write_cmd(0xCE);        // 
	lcd_spi_write_data(0x09); 
	lcd_spi_write_cmd(0xCF);        // 
	lcd_spi_write_data(0x00); 
	
	lcd_spi_write_cmd(0xFF); // Change to Page 6 CMD for GIP timing   
	lcd_spi_write_data(0xFF); 
	lcd_spi_write_data(0x98); 
	lcd_spi_write_data(0x06); 
	lcd_spi_write_data(0x04); 
	...
	lcd_spi_write_cmd(0x01);        // 
	lcd_spi_write_data(0x0A); 
	lcd_spi_write_cmd(0x02);        // 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0x03);        // 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0x04);        // 
	lcd_spi_write_data(0x01); 
	lcd_spi_write_cmd(0x05);        // 
	lcd_spi_write_data(0x01); 
	lcd_spi_write_cmd(0x06);        // 
	lcd_spi_write_data(0x98); 
	lcd_spi_write_cmd(0x07);        // 
	lcd_spi_write_data(0x06); 
	lcd_spi_write_cmd(0x08);        // 
	lcd_spi_write_data(0x01); 
	lcd_spi_write_cmd(0x09);        // 
	lcd_spi_write_data(0x80); 
	lcd_spi_write_cmd(0x0A);        // 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0x0B);        // 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0x0C);        // 
	lcd_spi_write_data(0x01); 
	lcd_spi_write_cmd(0x0D);        // 
	lcd_spi_write_data(0x01); 
	lcd_spi_write_cmd(0x0E);        // 
	lcd_spi_write_data(0x05); 
	lcd_spi_write_cmd(0x0F);        // 
	lcd_spi_write_data(0x00);

	lcd_spi_write_cmd(0x10);        // 
	lcd_spi_write_data(0xF0); 
	lcd_spi_write_cmd(0x11);        // 
	lcd_spi_write_data(0xF4); 
	lcd_spi_write_cmd(0x12);        // 
	lcd_spi_write_data(0x01); 
	lcd_spi_write_cmd(0x13);        // 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0x14);        // 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0x15);        // 
	lcd_spi_write_data(0xC0); 
	lcd_spi_write_cmd(0x16);        // 
	lcd_spi_write_data(0x08); 
	lcd_spi_write_cmd(0x17);        // 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0x18);        // 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0x19);        // 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0x1A);        // 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0x1B);        // 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0x1C);        // 
	lcd_spi_write_data(0x00); 
	lcd_spi_write_cmd(0x1D);        // 
	lcd_spi_write_data(0x00); 

	lcd_spi_write_cmd(0x20);        // 
	lcd_spi_write_data(0x01); 
	lcd_spi_write_cmd(0x21);        // 
	lcd_spi_write_data(0x23); 
	lcd_spi_write_cmd(0x22);        // 
	lcd_spi_write_data(0x45); 
	lcd_spi_write_cmd(0x23);        // 
	lcd_spi_write_data(0x67); 
	lcd_spi_write_cmd(0x24);        // 
	lcd_spi_write_data(0x01); 
	lcd_spi_write_cmd(0x25);        // 
	lcd_spi_write_data(0x23); 
	lcd_spi_write_cmd(0x26);        // 
	lcd_spi_write_data(0x45); 
	lcd_spi_write_cmd(0x27);        // 
	lcd_spi_write_data(0x67); 

	lcd_spi_write_cmd(0x30);        // 
	lcd_spi_write_data(0x11); 
	lcd_spi_write_cmd(0x31);        // 
	lcd_spi_write_data(0x11); 
	lcd_spi_write_cmd(0x32);        // 
	lcd_spi_write_data(0x00); 
	...
	lcd_spi_write_data(0xDD); 
	lcd_spi_write_cmd(0x38);        // 
	lcd_spi_write_data(0xCC); 
	lcd_spi_write_cmd(0x39);        // 
	lcd_spi_write_data(0x66); 
	lcd_spi_write_cmd(0x3A);        // 
	lcd_spi_write_data(0x77); 
	lcd_spi_write_cmd(0x3B);        // 
	lcd_spi_write_data(0x22); 
	lcd_spi_write_cmd(0x3C);        // 
	lcd_spi_write_data(0x22); 
	lcd_spi_write_cmd(0x3D);        // 
	lcd_spi_write_data(0x22); 
	lcd_spi_write_cmd(0x3E);        // 
	lcd_spi_write_data(0x22); 
	lcd_spi_write_cmd(0x3F);        // 
	lcd_spi_write_data(0x22); 
	lcd_spi_write_cmd(0x40);        // 
	lcd_spi_write_data(0x22); 

	lcd_spi_write_cmd(0xFF);// Change to Page 7 CMD for GIP timing   
	lcd_spi_write_data(0xFF); 
	lcd_spi_write_data(0x98); 
	lcd_spi_write_data(0x06); 
	lcd_spi_write_data(0x04); 
	...
	lcd_spi_write_cmd(0x26);        
	lcd_spi_write_data(0xB2); 

	lcd_spi_write_cmd(0xFF); // Change to Page 0 CMD for Normal command 
	lcd_spi_write_data(0xFF); 
	lcd_spi_write_data(0x98); 
	lcd_spi_write_data(0x06); 
	lcd_spi_write_data(0x04); 
...
#ifdef PIN_480_800
	lcd_spi_write_hf_word_cmd(0xB500); lcd_spi_write_hf_word_data(0x0050);	//0x6b ???? 480x854       0x50 ???? 480x800
#else
	lcd_spi_write_hf_word_cmd(0xB500); lcd_spi_write_hf_word_data(0x006B);	//0x6b ???? 480x854       0x50 ???? 480x800
#endif
