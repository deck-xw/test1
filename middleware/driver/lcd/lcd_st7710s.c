...
static const lcd_rgb_t lcd_rgb =
	{
		.clk = LCD_20M,
		.data_out_clk_edge = POSEDGE_OUTPUT,//NEGEDGE_OUTPUT,

		.hsync_pulse_width = 10,
		.vsync_pulse_width = 4,
		.hsync_back_porch = 10, // 3
		.hsync_front_porch = 38, // 2
		.vsync_back_porch = 4,	// 1
		.vsync_front_porch = 8, // 1
};

static void lcd_st7710s_config(void)
{
	os_printf("lcd_st7710s_config\r\n");
	...
	lcd_spi_write_data(0x35);
	//---------------------------------ST7789S Power setting--------------------------------------//
	lcd_spi_write_cmd(0xbb);
	lcd_spi_write_data(0x35);
	...
	lcd_spi_write_data(0x2a);
	lcd_spi_write_data(0x3c);
	lcd_spi_write_data(0x55);
	lcd_spi_write_data(0x4b);
	...
	lcd_spi_write_data(0x09);
	lcd_spi_write_data(0x0b);
	lcd_spi_write_data(0x29);
	lcd_spi_write_data(0x36);
