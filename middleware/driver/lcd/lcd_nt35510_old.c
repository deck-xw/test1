...
static const lcd_rgb_t lcd_rgb =
{
	...
	.hsync_pulse_width = 2,
	.hsync_back_porch = 5,  //case 60Mhz:  type = 0.5us
	.hsync_front_porch = 5,  // case 60Mhz:  type = 0.5us
	.vsync_pulse_width = 2,
	.vsync_back_porch = 5,   // >=5
	.vsync_front_porch = 5,   // >=2
#else
    .clk = LCD_20M,
	.data_out_clk_edge = NEGEDGE_OUTPUT,
...
static void lcd_nt35510_config(void)
{
	...
	lcd_spi_write_hf_word_cmd(0xB500); lcd_spi_write_hf_word_data(0x006B);
	...
	lcd_spi_write_hf_word_cmd(0x3a00); lcd_spi_write_hf_word_data(0x0077); //55:16ǋ   66:18ǋ   77:24ǋ
...
// AVDD: manual);
lcd_spi_write_hf_word_cmd(0xB600);lcd_spi_write_hf_word_data(0x34);
lcd_spi_write_hf_word_cmd(0xB601);lcd_spi_write_hf_word_data(0x34);
lcd_spi_write_hf_word_cmd(0xB602);lcd_spi_write_hf_word_data(0x34);
lcd_spi_write_hf_word_cmd(0xB000);lcd_spi_write_hf_word_data(0x09);
lcd_spi_write_hf_word_cmd(0xB001);lcd_spi_write_hf_word_data(0x09);
lcd_spi_write_hf_word_cmd(0xB002);lcd_spi_write_hf_word_data(0x09);
// AVEE: manual);

lcd_spi_write_hf_word_cmd(0xB700);lcd_spi_write_hf_word_data(0x24);
lcd_spi_write_hf_word_cmd(0xB701);lcd_spi_write_hf_word_data(0x24);
lcd_spi_write_hf_word_cmd(0xB702);lcd_spi_write_hf_word_data(0x24);
lcd_spi_write_hf_word_cmd(0xB100);lcd_spi_write_hf_word_data(0x09);
lcd_spi_write_hf_word_cmd(0xB101);lcd_spi_write_hf_word_data(0x09);
lcd_spi_write_hf_word_cmd(0xB102);lcd_spi_write_hf_word_data(0x09);
//Power Control for VCL
lcd_spi_write_hf_word_cmd(0xB800);lcd_spi_write_hf_word_data(0x34);
lcd_spi_write_hf_word_cmd(0xB200);lcd_spi_write_hf_word_data(0x00);
// VGH: Clamp Enable);lcd_spi_write_hf_word_data(
lcd_spi_write_hf_word_cmd(0xB900);lcd_spi_write_hf_word_data(0x24);
lcd_spi_write_hf_word_cmd(0xB901);lcd_spi_write_hf_word_data(0x24);
lcd_spi_write_hf_word_cmd(0xB902);lcd_spi_write_hf_word_data(0x24);
lcd_spi_write_hf_word_cmd(0xB300);lcd_spi_write_hf_word_data(0x05);
lcd_spi_write_hf_word_cmd(0xB301);lcd_spi_write_hf_word_data(0x05);
lcd_spi_write_hf_word_cmd(0xB302);lcd_spi_write_hf_word_data(0x05);
lcd_spi_write_hf_word_cmd(0xBF00);lcd_spi_write_hf_word_data(0x01);
// VGL(LVGL)
lcd_spi_write_hf_word_cmd(0xBA00);lcd_spi_write_hf_word_data(0x34);
lcd_spi_write_hf_word_cmd(0xBA01);lcd_spi_write_hf_word_data(0x34);
lcd_spi_write_hf_word_cmd(0xBA02);lcd_spi_write_hf_word_data(0x34);
// VGL_REG(VGLO)
lcd_spi_write_hf_word_cmd(0xB500);lcd_spi_write_hf_word_data(0x0B);
lcd_spi_write_hf_word_cmd(0xB501);lcd_spi_write_hf_word_data(0x0B);
lcd_spi_write_hf_word_cmd(0xB502);lcd_spi_write_hf_word_data(0x0B);
// VGMP/VGSP
lcd_spi_write_hf_word_cmd(0xBC00);lcd_spi_write_hf_word_data(0X00);
lcd_spi_write_hf_word_cmd(0xBC01);lcd_spi_write_hf_word_data(0xA3);
lcd_spi_write_hf_word_cmd(0xBC02);lcd_spi_write_hf_word_data(0X00);
//VGMN/VGSN
lcd_spi_write_hf_word_cmd(0xBD00);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xBD01);lcd_spi_write_hf_word_data(0xA3);
lcd_spi_write_hf_word_cmd(0xBD02);lcd_spi_write_hf_word_data(0x00);
// VCOM=

lcd_spi_write_hf_word_cmd(0xBE00);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xBE01);lcd_spi_write_hf_word_data(0x50);
//R+
lcd_spi_write_hf_word_cmd(0xD100);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD101);lcd_spi_write_hf_word_data(0x37);
lcd_spi_write_hf_word_cmd(0xD102);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD103);lcd_spi_write_hf_word_data(0x52);
lcd_spi_write_hf_word_cmd(0xD104);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD105);lcd_spi_write_hf_word_data(0x7B);
lcd_spi_write_hf_word_cmd(0xD106);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD107);lcd_spi_write_hf_word_data(0x99);
lcd_spi_write_hf_word_cmd(0xD108);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD109);lcd_spi_write_hf_word_data(0xB1);
lcd_spi_write_hf_word_cmd(0xD10A);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD10B);lcd_spi_write_hf_word_data(0xD2);
lcd_spi_write_hf_word_cmd(0xD10C);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD10D);lcd_spi_write_hf_word_data(0xF6);
lcd_spi_write_hf_word_cmd(0xD10E);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD10F);lcd_spi_write_hf_word_data(0x27);
lcd_spi_write_hf_word_cmd(0xD110);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD111);lcd_spi_write_hf_word_data(0x4E);
lcd_spi_write_hf_word_cmd(0xD112);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD113);lcd_spi_write_hf_word_data(0x8C);
lcd_spi_write_hf_word_cmd(0xD114);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD115);lcd_spi_write_hf_word_data(0xBE);
lcd_spi_write_hf_word_cmd(0xD116);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD117);lcd_spi_write_hf_word_data(0x0B);
lcd_spi_write_hf_word_cmd(0xD118);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD119);lcd_spi_write_hf_word_data(0x48);
lcd_spi_write_hf_word_cmd(0xD11A);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD11B);lcd_spi_write_hf_word_data(0x4A);
lcd_spi_write_hf_word_cmd(0xD11C);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD11D);lcd_spi_write_hf_word_data(0x7E);
lcd_spi_write_hf_word_cmd(0xD11E);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD11F);lcd_spi_write_hf_word_data(0xBC);
lcd_spi_write_hf_word_cmd(0xD120);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD121);lcd_spi_write_hf_word_data(0xE1);
lcd_spi_write_hf_word_cmd(0xD122);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD123);lcd_spi_write_hf_word_data(0x10);
lcd_spi_write_hf_word_cmd(0xD124);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD125);lcd_spi_write_hf_word_data(0x31);
lcd_spi_write_hf_word_cmd(0xD126);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD127);lcd_spi_write_hf_word_data(0x5A);
lcd_spi_write_hf_word_cmd(0xD128);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD129);lcd_spi_write_hf_word_data(0x73);
lcd_spi_write_hf_word_cmd(0xD12A);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD12B);lcd_spi_write_hf_word_data(0x94);
lcd_spi_write_hf_word_cmd(0xD12C);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD12D);lcd_spi_write_hf_word_data(0x9F);
lcd_spi_write_hf_word_cmd(0xD12E);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD12F);lcd_spi_write_hf_word_data(0xB3);
lcd_spi_write_hf_word_cmd(0xD130);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD131);lcd_spi_write_hf_word_data(0xB9);
lcd_spi_write_hf_word_cmd(0xD132);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD133);lcd_spi_write_hf_word_data(0xC1);
//G+
lcd_spi_write_hf_word_cmd(0xD200);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD201);lcd_spi_write_hf_word_data(0x37);
lcd_spi_write_hf_word_cmd(0xD202);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD203);lcd_spi_write_hf_word_data(0x52);
lcd_spi_write_hf_word_cmd(0xD204);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD205);lcd_spi_write_hf_word_data(0x7B);
lcd_spi_write_hf_word_cmd(0xD206);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD207);lcd_spi_write_hf_word_data(0x99);
lcd_spi_write_hf_word_cmd(0xD208);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD209);lcd_spi_write_hf_word_data(0xB1);
lcd_spi_write_hf_word_cmd(0xD20A);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD20B);lcd_spi_write_hf_word_data(0xD2);
lcd_spi_write_hf_word_cmd(0xD20C);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD20D);lcd_spi_write_hf_word_data(0xF6);
lcd_spi_write_hf_word_cmd(0xD20E);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD20F);lcd_spi_write_hf_word_data(0x27);
lcd_spi_write_hf_word_cmd(0xD210);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD211);lcd_spi_write_hf_word_data(0x4E);
lcd_spi_write_hf_word_cmd(0xD212);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD213);lcd_spi_write_hf_word_data(0x8C);
lcd_spi_write_hf_word_cmd(0xD214);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD215);lcd_spi_write_hf_word_data(0xBE);
lcd_spi_write_hf_word_cmd(0xD216);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD217);lcd_spi_write_hf_word_data(0x0B);
lcd_spi_write_hf_word_cmd(0xD218);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD219);lcd_spi_write_hf_word_data(0x48);
lcd_spi_write_hf_word_cmd(0xD21A);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD21B);lcd_spi_write_hf_word_data(0x4A);
lcd_spi_write_hf_word_cmd(0xD21C);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD21D);lcd_spi_write_hf_word_data(0x7E);
lcd_spi_write_hf_word_cmd(0xD21E);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD21F);lcd_spi_write_hf_word_data(0xBC);
lcd_spi_write_hf_word_cmd(0xD220);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD221);lcd_spi_write_hf_word_data(0xE1);
lcd_spi_write_hf_word_cmd(0xD222);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD223);lcd_spi_write_hf_word_data(0x10);
lcd_spi_write_hf_word_cmd(0xD224);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD225);lcd_spi_write_hf_word_data(0x31);
lcd_spi_write_hf_word_cmd(0xD226);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD227);lcd_spi_write_hf_word_data(0x5A);
lcd_spi_write_hf_word_cmd(0xD228);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD229);lcd_spi_write_hf_word_data(0x73);
lcd_spi_write_hf_word_cmd(0xD22A);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD22B);lcd_spi_write_hf_word_data(0x94);
lcd_spi_write_hf_word_cmd(0xD22C);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD22D);lcd_spi_write_hf_word_data(0x9F);
lcd_spi_write_hf_word_cmd(0xD22E);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD22F);lcd_spi_write_hf_word_data(0xB3);
lcd_spi_write_hf_word_cmd(0xD230);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD231);lcd_spi_write_hf_word_data(0xB9);
lcd_spi_write_hf_word_cmd(0xD232);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD233);lcd_spi_write_hf_word_data(0xC1);
//B+
lcd_spi_write_hf_word_cmd(0xD300);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD301);lcd_spi_write_hf_word_data(0x37);
lcd_spi_write_hf_word_cmd(0xD302);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD303);lcd_spi_write_hf_word_data(0x52);
lcd_spi_write_hf_word_cmd(0xD304);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD305);lcd_spi_write_hf_word_data(0x7B);
lcd_spi_write_hf_word_cmd(0xD306);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD307);lcd_spi_write_hf_word_data(0x99);
lcd_spi_write_hf_word_cmd(0xD308);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD309);lcd_spi_write_hf_word_data(0xB1);
lcd_spi_write_hf_word_cmd(0xD30A);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD30B);lcd_spi_write_hf_word_data(0xD2);
lcd_spi_write_hf_word_cmd(0xD30C);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD30D);lcd_spi_write_hf_word_data(0xF6);
lcd_spi_write_hf_word_cmd(0xD30E);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD30F);lcd_spi_write_hf_word_data(0x27);
lcd_spi_write_hf_word_cmd(0xD310);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD311);lcd_spi_write_hf_word_data(0x4E);
lcd_spi_write_hf_word_cmd(0xD312);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD313);lcd_spi_write_hf_word_data(0x8C);
lcd_spi_write_hf_word_cmd(0xD314);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD315);lcd_spi_write_hf_word_data(0xBE);
lcd_spi_write_hf_word_cmd(0xD316);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD317);lcd_spi_write_hf_word_data(0x0B);
lcd_spi_write_hf_word_cmd(0xD318);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD319);lcd_spi_write_hf_word_data(0x48);
lcd_spi_write_hf_word_cmd(0xD31A);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD31B);lcd_spi_write_hf_word_data(0x4A);
lcd_spi_write_hf_word_cmd(0xD31C);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD31D);lcd_spi_write_hf_word_data(0x7E);
lcd_spi_write_hf_word_cmd(0xD31E);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD31F);lcd_spi_write_hf_word_data(0xBC);
lcd_spi_write_hf_word_cmd(0xD320);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD321);lcd_spi_write_hf_word_data(0xE1);
lcd_spi_write_hf_word_cmd(0xD322);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD323);lcd_spi_write_hf_word_data(0x10);
lcd_spi_write_hf_word_cmd(0xD324);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD325);lcd_spi_write_hf_word_data(0x31);
lcd_spi_write_hf_word_cmd(0xD326);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD327);lcd_spi_write_hf_word_data(0x5A);
lcd_spi_write_hf_word_cmd(0xD328);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD329);lcd_spi_write_hf_word_data(0x73);
lcd_spi_write_hf_word_cmd(0xD32A);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD32B);lcd_spi_write_hf_word_data(0x94);
lcd_spi_write_hf_word_cmd(0xD32C);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD32D);lcd_spi_write_hf_word_data(0x9F);
lcd_spi_write_hf_word_cmd(0xD32E);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD32F);lcd_spi_write_hf_word_data(0xB3);
lcd_spi_write_hf_word_cmd(0xD330);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD331);lcd_spi_write_hf_word_data(0xB9);
lcd_spi_write_hf_word_cmd(0xD332);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD333);lcd_spi_write_hf_word_data(0xC1);
//RREGW
lcd_spi_write_hf_word_cmd(0xD400);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD401);lcd_spi_write_hf_word_data(0x37);
lcd_spi_write_hf_word_cmd(0xD402);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD403);lcd_spi_write_hf_word_data(0x52);
lcd_spi_write_hf_word_cmd(0xD404);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD405);lcd_spi_write_hf_word_data(0x7B);
lcd_spi_write_hf_word_cmd(0xD406);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD407);lcd_spi_write_hf_word_data(0x99);
lcd_spi_write_hf_word_cmd(0xD408);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD409);lcd_spi_write_hf_word_data(0xB1);
lcd_spi_write_hf_word_cmd(0xD40A);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD40B);lcd_spi_write_hf_word_data(0xD2);
lcd_spi_write_hf_word_cmd(0xD40C);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD40D);lcd_spi_write_hf_word_data(0xF6);
lcd_spi_write_hf_word_cmd(0xD40E);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD40F);lcd_spi_write_hf_word_data(0x27);
lcd_spi_write_hf_word_cmd(0xD410);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD411);lcd_spi_write_hf_word_data(0x4E);
lcd_spi_write_hf_word_cmd(0xD412);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD413);lcd_spi_write_hf_word_data(0x8C);
lcd_spi_write_hf_word_cmd(0xD414);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD415);lcd_spi_write_hf_word_data(0xBE);
lcd_spi_write_hf_word_cmd(0xD416);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD417);lcd_spi_write_hf_word_data(0x0B);
lcd_spi_write_hf_word_cmd(0xD418);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD419);lcd_spi_write_hf_word_data(0x48);
lcd_spi_write_hf_word_cmd(0xD41A);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD41B);lcd_spi_write_hf_word_data(0x4A);
lcd_spi_write_hf_word_cmd(0xD41C);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD41D);lcd_spi_write_hf_word_data(0x7E);
lcd_spi_write_hf_word_cmd(0xD41E);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD41F);lcd_spi_write_hf_word_data(0xBC);
lcd_spi_write_hf_word_cmd(0xD420);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD421);lcd_spi_write_hf_word_data(0xE1);
lcd_spi_write_hf_word_cmd(0xD422);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD423);lcd_spi_write_hf_word_data(0x10);
lcd_spi_write_hf_word_cmd(0xD424);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD425);lcd_spi_write_hf_word_data(0x31);
lcd_spi_write_hf_word_cmd(0xD426);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD427);lcd_spi_write_hf_word_data(0x5A);
lcd_spi_write_hf_word_cmd(0xD428);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD429);lcd_spi_write_hf_word_data(0x73);
lcd_spi_write_hf_word_cmd(0xD42A);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD42B);lcd_spi_write_hf_word_data(0x94);
lcd_spi_write_hf_word_cmd(0xD42C);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD42D);lcd_spi_write_hf_word_data(0x9F);
lcd_spi_write_hf_word_cmd(0xD42E);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD42F);lcd_spi_write_hf_word_data(0xB3);
lcd_spi_write_hf_word_cmd(0xD430);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD431);lcd_spi_write_hf_word_data(0xB9);
lcd_spi_write_hf_word_cmd(0xD432);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD433);lcd_spi_write_hf_word_data(0xC1);
//GREGW
lcd_spi_write_hf_word_cmd(0xD500);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD501);lcd_spi_write_hf_word_data(0x37);
lcd_spi_write_hf_word_cmd(0xD502);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD503);lcd_spi_write_hf_word_data(0x52);
lcd_spi_write_hf_word_cmd(0xD504);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD505);lcd_spi_write_hf_word_data(0x7B);
lcd_spi_write_hf_word_cmd(0xD506);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD507);lcd_spi_write_hf_word_data(0x99);
lcd_spi_write_hf_word_cmd(0xD508);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD509);lcd_spi_write_hf_word_data(0xB1);
lcd_spi_write_hf_word_cmd(0xD50A);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD50B);lcd_spi_write_hf_word_data(0xD2);
lcd_spi_write_hf_word_cmd(0xD50C);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD50D);lcd_spi_write_hf_word_data(0xF6);
lcd_spi_write_hf_word_cmd(0xD50E);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD50F);lcd_spi_write_hf_word_data(0x27);
lcd_spi_write_hf_word_cmd(0xD510);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD511);lcd_spi_write_hf_word_data(0x4E);
lcd_spi_write_hf_word_cmd(0xD512);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD513);lcd_spi_write_hf_word_data(0x8C);
lcd_spi_write_hf_word_cmd(0xD514);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD515);lcd_spi_write_hf_word_data(0xBE);
lcd_spi_write_hf_word_cmd(0xD516);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD517);lcd_spi_write_hf_word_data(0x0B);
lcd_spi_write_hf_word_cmd(0xD518);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD519);lcd_spi_write_hf_word_data(0x48);
lcd_spi_write_hf_word_cmd(0xD51A);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD51B);lcd_spi_write_hf_word_data(0x4A);
lcd_spi_write_hf_word_cmd(0xD51C);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD51D);lcd_spi_write_hf_word_data(0x7E);
lcd_spi_write_hf_word_cmd(0xD51E);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD51F);lcd_spi_write_hf_word_data(0xBC);
lcd_spi_write_hf_word_cmd(0xD520);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD521);lcd_spi_write_hf_word_data(0xE1);
lcd_spi_write_hf_word_cmd(0xD522);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD523);lcd_spi_write_hf_word_data(0x10);
lcd_spi_write_hf_word_cmd(0xD524);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD525);lcd_spi_write_hf_word_data(0x31);
lcd_spi_write_hf_word_cmd(0xD526);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD527);lcd_spi_write_hf_word_data(0x5A);
lcd_spi_write_hf_word_cmd(0xD528);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD529);lcd_spi_write_hf_word_data(0x73);
lcd_spi_write_hf_word_cmd(0xD52A);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD52B);lcd_spi_write_hf_word_data(0x94);
lcd_spi_write_hf_word_cmd(0xD52C);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD52D);lcd_spi_write_hf_word_data(0x9F);
lcd_spi_write_hf_word_cmd(0xD52E);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD52F);lcd_spi_write_hf_word_data(0xB3);
lcd_spi_write_hf_word_cmd(0xD530);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD531);lcd_spi_write_hf_word_data(0xB9);
lcd_spi_write_hf_word_cmd(0xD532);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD533);lcd_spi_write_hf_word_data(0xC1);
//BREGW
lcd_spi_write_hf_word_cmd(0xD600);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD601);lcd_spi_write_hf_word_data(0x37);
lcd_spi_write_hf_word_cmd(0xD602);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD603);lcd_spi_write_hf_word_data(0x52);
lcd_spi_write_hf_word_cmd(0xD604);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD605);lcd_spi_write_hf_word_data(0x7B);
lcd_spi_write_hf_word_cmd(0xD606);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD607);lcd_spi_write_hf_word_data(0x99);
lcd_spi_write_hf_word_cmd(0xD608);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD609);lcd_spi_write_hf_word_data(0xB1);
lcd_spi_write_hf_word_cmd(0xD60A);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD60B);lcd_spi_write_hf_word_data(0xD2);
lcd_spi_write_hf_word_cmd(0xD60C);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xD60D);lcd_spi_write_hf_word_data(0xF6);
lcd_spi_write_hf_word_cmd(0xD60E);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD60F);lcd_spi_write_hf_word_data(0x27);
lcd_spi_write_hf_word_cmd(0xD610);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD611);lcd_spi_write_hf_word_data(0x4E);
lcd_spi_write_hf_word_cmd(0xD612);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD613);lcd_spi_write_hf_word_data(0x8C);
lcd_spi_write_hf_word_cmd(0xD614);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xD615);lcd_spi_write_hf_word_data(0xBE);
lcd_spi_write_hf_word_cmd(0xD616);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD617);lcd_spi_write_hf_word_data(0x0B);
lcd_spi_write_hf_word_cmd(0xD618);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD619);lcd_spi_write_hf_word_data(0x48);
lcd_spi_write_hf_word_cmd(0xD61A);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD61B);lcd_spi_write_hf_word_data(0x4A);
lcd_spi_write_hf_word_cmd(0xD61C);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD61D);lcd_spi_write_hf_word_data(0x7E);
lcd_spi_write_hf_word_cmd(0xD61E);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD61F);lcd_spi_write_hf_word_data(0xBC);
lcd_spi_write_hf_word_cmd(0xD620);lcd_spi_write_hf_word_data(0x02);
lcd_spi_write_hf_word_cmd(0xD621);lcd_spi_write_hf_word_data(0xE1);
lcd_spi_write_hf_word_cmd(0xD622);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD623);lcd_spi_write_hf_word_data(0x10);
lcd_spi_write_hf_word_cmd(0xD624);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD625);lcd_spi_write_hf_word_data(0x31);
lcd_spi_write_hf_word_cmd(0xD626);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD627);lcd_spi_write_hf_word_data(0x5A);
lcd_spi_write_hf_word_cmd(0xD628);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD629);lcd_spi_write_hf_word_data(0x73);
lcd_spi_write_hf_word_cmd(0xD62A);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD62B);lcd_spi_write_hf_word_data(0x94);
lcd_spi_write_hf_word_cmd(0xD62C);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD62D);lcd_spi_write_hf_word_data(0x9F);
lcd_spi_write_hf_word_cmd(0xD62E);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD62F);lcd_spi_write_hf_word_data(0xB3);
lcd_spi_write_hf_word_cmd(0xD630);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD631);lcd_spi_write_hf_word_data(0xB9);
lcd_spi_write_hf_word_cmd(0xD632);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xD633);lcd_spi_write_hf_word_data(0xC1);
//Enable Page0
lcd_spi_write_hf_word_cmd(0xF000);lcd_spi_write_hf_word_data(0x55);
lcd_spi_write_hf_word_cmd(0xF001);lcd_spi_write_hf_word_data(0xAA);
lcd_spi_write_hf_word_cmd(0xF002);lcd_spi_write_hf_word_data(0x52);
...
lcd_spi_write_hf_word_cmd(0xB001);lcd_spi_write_hf_word_data(0x05); //
lcd_spi_write_hf_word_cmd(0xB002);lcd_spi_write_hf_word_data(0x02); //
lcd_spi_write_hf_word_cmd(0xB003);lcd_spi_write_hf_word_data(0x05); //
lcd_spi_write_hf_word_cmd(0xB004);lcd_spi_write_hf_word_data(0x02); //
// SDT:
lcd_spi_write_hf_word_cmd(0xB600);lcd_spi_write_hf_word_data(0x0A);
// Gate EQ:
lcd_spi_write_hf_word_cmd(0xB700);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xB701);lcd_spi_write_hf_word_data(0x70);
// Source EQ
lcd_spi_write_hf_word_cmd(0xB800);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xB801);lcd_spi_write_hf_word_data(0x05);
lcd_spi_write_hf_word_cmd(0xB802);lcd_spi_write_hf_word_data(0x05);
lcd_spi_write_hf_word_cmd(0xB803);lcd_spi_write_hf_word_data(0x05);
//Inversion: Column inversion (NVT)
lcd_spi_write_hf_word_cmd(0xBC00);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xBC01);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xBC02);lcd_spi_write_hf_word_data(0x00);
//BOE's Setting (default)
lcd_spi_write_hf_word_cmd(0xCC00);lcd_spi_write_hf_word_data(0x03);
lcd_spi_write_hf_word_cmd(0xCC01);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xCC02);lcd_spi_write_hf_word_data(0x00);
//Display Timing
lcd_spi_write_hf_word_cmd(0xBD00);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xBD01);lcd_spi_write_hf_word_data(0x84);
lcd_spi_write_hf_word_cmd(0xBD02);lcd_spi_write_hf_word_data(0x07);
lcd_spi_write_hf_word_cmd(0xBD03);lcd_spi_write_hf_word_data(0x31);
lcd_spi_write_hf_word_cmd(0xBD04);lcd_spi_write_hf_word_data(0x00);
lcd_spi_write_hf_word_cmd(0xBA00);lcd_spi_write_hf_word_data(0x01);
lcd_spi_write_hf_word_cmd(0xFF00);lcd_spi_write_hf_word_data(0xAA);
lcd_spi_write_hf_word_cmd(0xFF01);lcd_spi_write_hf_word_data(0x55);
lcd_spi_write_hf_word_cmd(0xFF02);lcd_spi_write_hf_word_data(0x25);
lcd_spi_write_hf_word_cmd(0xFF03);lcd_spi_write_hf_word_data(0x01);

lcd_spi_write_hf_word_cmd(0x3600);lcd_spi_write_hf_word_data(0x08);
lcd_spi_write_hf_word_cmd(0x3A00);lcd_spi_write_hf_word_data(0x55);// 0X55  16bit
...
static void lcd_nt35510_init(void)
{
	lcd_nt35510_backlight_io_init();
	lcd_spi_init_gpio();
	lcd_nt35510_config();
}
...
{
	.id = LCD_DEVICE_NT35510,
	.name = "nt35510",
	.type = LCD_TYPE_RGB565,
	.ppi = PPI_480X854,
	.rgb = &lcd_rgb,
	.backlight_open = nt35510_lcd_backlight_open,
	.backlight_set = NULL,
