...
extern bk_err_t bk_usb_uvc_attribute_op(E_UVC_ATTRIBUTE_OP ops, E_UVC_ATTRIBUTE_T attribute, uint32_t *param);
...
extern bk_err_t bk_usb_uac_set_hz(USB_DEVICE_WORKING_STATUS dev, uint32 hz);
extern bk_err_t bk_usb_uac_set_volume(uint32_t param);
extern bk_err_t bk_usb_uac_get_volume(uint32_t *param);
